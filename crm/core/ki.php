<?php
// Uebernommen aus dem bulkify Dashboard (core/ki.php) und bewusst unveraendert gelassen:
// dieselbe erprobte Anbindung, damit sich beide Programme gleich verhalten. Der Schluessel
// steht in der secrets.php DIESES Projekts (ANTHROPIC_API_KEY).
