...
- **Anzeige:** Kennzahlen (Status, Fortschritt X/N, **Packungen gesamt** = `menge`, **… je Packung** = `einheiten_pro_packung`, **… gesamt** = Packungen × je Packung; das Wort ist „Kapseln"/„Tabletten"/„Stück" je Darreichungsform, Karten ohne Wert entfallen), Produkt) und die Stationen als Ablaufliste:
