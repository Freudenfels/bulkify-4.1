...
**Bedienung:**
- Tabelle: Rezeptur (Name ist ein Link zu **`?p=lieferant_rezeptur`** – Zusammensetzung ansehen) · Form · **Ihr Preis** (inline editierbar, „Aktualisieren" setzt `stand=heute`) · Stand (mit „!" wenn überfällig) · Löschen.
