...
## Angebot abgeben
Über dem Preisfeld steht, **für welche Menge** der Preis gilt (die angefragte Menge). Die Staffel ist **zugeklappt** und öffnet sich per Klick auf „Mengenstaffeln" (`<details>`, kein JavaScript); hat der Lieferant schon eine abgegeben, ist sie offen. Spaltenreihenfolge wie oben im Formular: erst **Preis**, dann **ab Menge**. Die erste Zeile ist mit der angefragten Menge vorbelegt – der Lieferant trägt nur den Preis daneben ein. Es starten drei Zeilen; **„+ Weitere Zeile"** hängt beliebig viele an, und nach gespeicherten Staffeln steht immer eine freie Zeile bereit. Weitere Zeilen sind **freiwillig** und nur dann sinnvoll, wenn andere Mengen günstiger werden. Ein Angebot ganz ohne Staffel ist gültig; dann zählt der Preis oben, und beim Übernehmen entsteht daraus eine Staffel ab der Mindestmenge.
