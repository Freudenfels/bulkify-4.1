...
function lp_t(string $key, string $sprache = ''): string {
    ...
    if ($texte === null) $texte = [
        ...
        'katalog_hoch_sub'=> ['de'=>'PDF, Bild oder CSV – auch als Scan. Die Liste wird ausgelesen und erscheint unten. Sie können danach noch korrigieren.',
                              'en'=>'PDF, image or CSV – scans work too. The list is read out and appears below; you can still correct it.',
                              'zh'=>'PDF、图片或 CSV，扫描件亦可。系统会自动读取并显示在下方，您仍可修改。'],
