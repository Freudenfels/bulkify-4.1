...
function lp_t(string $key, string $sprache = ''): string {
    ...
    if ($texte === null) $texte = [
        ...
        'angebot_gesperrt'=> ['de'=>'Dieses Angebot wurde bereits angenommen und kann nicht mehr geändert werden. Bei Fragen sprechen Sie uns bitte an.',
                              'en'=>'This quote has already been accepted and can no longer be changed. Please contact us if you have any questions.',
                              'zh'=>'该报价已被接受，无法再修改。如有疑问，请与我们联系。'],
        ...
        'vers_see'        => ['de'=>'See (Sea)',               'en'=>'Sea',   'zh'=>'海运'],
        'vers_bahn'       => ['de'=>'Bahn (Train)',            'en'=>'Rail',  'zh'=>'铁路'],
        'vers_lkw'        => ['de'=>'LKW / Straße',            'en'=>'Truck', 'zh'=>'陆运'],
        'vers_express'    => ['de'=>'Express',                 'en'=>'Express','zh'=>'快递'],
        'vers_standard'   => ['de'=>'Standard',                'en'=>'Standard','zh'=>'标准'],
        'gewuenscht_von_uns' => ['de'=>'von uns gewünscht',    'en'=>'requested by us', 'zh'=>'我方要求'],
        ...
        'btn_katalog'     => ['de'=>'Katalog hochladen',        'en'=>'Upload catalog', 'zh'=>'上传目录'],
        ...
        'preis_intervall_hint'=>['de'=>'Regel: aktualisieren alle', 'en'=>'Rule: update every', 'zh'=>'规则：每'],
        'tage'            => ['de'=>'Tage',                     'en'=>'days', 'zh'=>'天'],
        'zuletzt_vor'     => ['de'=>'zuletzt vor',              'en'=>'last update', 'zh'=>'上次更新于'],
        ...
        'rez_preise_leer' => ['de'=>'Noch keine Preise. Unten eine Rezeptur wählen und Preis eintragen.', 'en'=>'No prices yet. Pick a formula below and enter a price.', 'zh'=>'暂无价格。请在下方选择配方并填写价格。'],
        'rez_preise_add'  => ['de'=>'Weitere Rezeptur bepreisen', 'en'=>'Price another formula', 'zh'=>'为其他配方报价'],
        'rez_ansehen'     => ['de'=>'Rezeptur ansehen',          'en'=>'View formula', 'zh'=>'查看配方'],
        'rez_zusammensetzung'=>['de'=>'Zusammensetzung je Einheit','en'=>'Composition per unit', 'zh'=>'每单位成分'],
        'bestandteil'     => ['de'=>'Bestandteil',              'en'=>'Component', 'zh'=>'成分'],
        'menge_je_einheit'=> ['de'=>'Menge je Einheit',         'en'=>'Amount per unit', 'zh'=>'每单位用量'],
        'fuellgewicht'    => ['de'=>'Füllgewicht je Einheit',   'en'=>'Fill weight per unit', 'zh'=>'每单位填充重量'],
        'rez_nicht_da'    => ['de'=>'Rezeptur nicht gefunden oder nicht für Sie freigeschaltet.', 'en'=>'Formula not found or not enabled for you.', 'zh'=>'未找到该配方，或未向您开通。'],
        'freigeschaltet_formen'=>['de'=>'Für Sie freigeschaltete Formen', 'en'=>'Forms enabled for you', 'zh'=>'为您开通的剂型'],
        'keine_formen'    => ['de'=>'Für Sie ist noch keine Darreichungsform freigeschaltet. Bitte wenden Sie sich an uns, dann schalten wir die passenden Formen (z. B. Kapseln) frei.',
                              'en'=>'No dosage form has been enabled for you yet. Please contact us and we will enable the right forms (e.g. capsules).',
                              'zh'=>'尚未为您开通任何剂型。请与我们联系，我们将为您开通合适的剂型（如胶囊）。'],
        ...
        'spec_hoch_sub'   => ['de'=>'PDF oder Bild, auch als Scan – in jeder Sprache (z. B. Chinesisch). Wir lesen es aus, übersetzen es und legen daraus einen Rohstoff-Vorschlag an. Sie müssen nichts eintippen.',
                              ...
                              'zh'=>'PDF 或图片，扫描件亦可，任意语言（如中文）。我方会读取并翻译，据此生成原料建议，您无需手动输入。'],
        'spec_lesen'      => ['de'=>'Auslesen',                 'en'=>'Read it', 'zh'=>'读取'],
        'spec_ok'         => ['de'=>'Danke – Rohstoff-Vorschlag angelegt und ans Team gemeldet:', 'en'=>'Thank you – raw-material proposal created and sent to the team:', 'zh'=>'谢谢，已生成原料建议并提交给团队：'],
        ...
        'katalog_leer'    => ['de'=>'Noch nichts hinterlegt. Nutzen Sie oben die Schaltflächen: Katalog hochladen, CoA/Spec hochladen oder manuell hinzufügen.',
                              'en'=>'Nothing here yet. Use the buttons above: upload a catalog, upload a CoA/Spec, or add manually.',
                              'zh'=>'尚无内容。请使用上方按钮：上传目录、上传 CoA/规格书或手动添加。'],
        ...
        'katalog_zeile_edit'    => ['de'=>'Artikel bearbeiten', 'en'=>'Edit item', 'zh'=>'编辑产品'],
...
function lp_shell_start(string $aktiv): void {
    ...
    $menu = [
        ...
        'lieferant_preisliste'  => lp_t('preisliste'),
