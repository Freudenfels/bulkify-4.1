<?php
// Verpackungs-Dokument ausliefern (aus data/uploads, außerhalb public). Zugriff über die Route geschützt.
require_once BX_ROOT . '/core/schema.php';

$id = (int)($_GET['id'] ?? 0);
$d  = $id ? one("SELECT datei, datei_orig FROM verpackung_dokument WHERE id=?", [$id]) : null;
